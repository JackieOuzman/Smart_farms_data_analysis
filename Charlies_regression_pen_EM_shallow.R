...
EMShallowVPeak <- ggplot(Charlies, aes(x=`EM05m`, y=`Peak_Resistance`)) + 
...
EMShallowVDepth_to_peak <- ggplot(Charlies, aes(x=`EM05m`, y=`Depth_to_peak`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
EMShallowVDepth_to_2.5MPa <- ggplot(Charlies, aes(x=`EM05m`, y=`Depth_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
EMShallowVArea_under_curve_to_2.5MPa <- ggplot(Charlies, aes(x=`EM05m`, y=`Area_under_curve_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
EMShallowVArea_under_curve_to_50cm <- ggplot(Charlies, aes(x=`EM05m`, y=`Area_under_curve_to_50cm`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
EMDeepVPeak <- ggplot(Charlies, aes(x=`EM1m`, y=`Peak_Resistance`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
EMDeepVDepth_to_peak <- ggplot(Charlies, aes(x=`EM1m`, y=`Depth_to_peak`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
EMDeepVDepth_to_2.5MPa <- ggplot(Charlies, aes(x=`EM1m`, y=`Depth_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
EMDeepVArea_under_curve_to_2.5MPa <- ggplot(Charlies, aes(x=`EM1m`, y=`Area_under_curve_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
EMDeepVArea_under_curve_to_50cm <- ggplot(Charlies, aes(x=`EM1m`, y=`Area_under_curve_to_50cm`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
