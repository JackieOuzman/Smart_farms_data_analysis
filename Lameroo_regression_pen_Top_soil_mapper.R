...
### import dataset  
##################################################################################
#"X:\Therese_Jackie\smart_farms\sites\Wikarie\Lameroo Pentrometer 1.3.23\Lameroo Pentrometer March 2023 Jaxs.csv"
...
correltion_matrix_pen_em_flat


write.csv(correltion_matrix_pen_em_flat,
          file = "X:/Therese_Jackie/smart_farms/sites/Wikarie/Analysis/correltion_matrix_pen_em_flat.csv",
          row.names = FALSE)



names(Lameroo)
Lameroo <- Lameroo %>% select(
...
ECa1VPeak <- ggplot(Lameroo, aes(x=`ECa1`, y=`Peak_Resistance`)) + 
...
ECa1VDepth_to_peak <- ggplot(Lameroo, aes(x=`ECa1`, y=`Depth_to_peak`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa1VDepth_to_2.5MPa <- ggplot(Lameroo, aes(x=`ECa1`, y=`Depth_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa1VArea_under_curve_to_2.5MPa <- ggplot(Lameroo, aes(x=`ECa1`, y=`Area_under_curve_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa1VArea_under_curve_to_50cm <- ggplot(Lameroo, aes(x=`ECa1`, y=`Area_under_curve_to_50cm`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa1_plots_Reg_1
ggexport(ECa1_plots_Reg_1, filename = "X:/Therese_Jackie/smart_farms/sites/Wikarie/Analysis/plots_regression/ECa1_plots_Reg.png")
...
ECa2VPeak <- ggplot(Lameroo, aes(x=`ECa2`, y=`Peak_Resistance`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa2VDepth_to_peak <- ggplot(Lameroo, aes(x=`ECa2`, y=`Depth_to_peak`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa2VDepth_to_2.5MPa <- ggplot(Lameroo, aes(x=`ECa2`, y=`Depth_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa2VArea_under_curve_to_2.5MPa <- ggplot(Lameroo, aes(x=`ECa2`, y=`Area_under_curve_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa2VArea_under_curve_to_50cm <- ggplot(Lameroo, aes(x=`ECa2`, y=`Area_under_curve_to_50cm`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa2_plots_Reg_1
ggexport(ECa2_plots_Reg_1, filename = "X:/Therese_Jackie/smart_farms/sites/Wikarie/Analysis/plots_regression/ECa2_plots_Reg.png")
...
ECa3VPeak <- ggplot(Lameroo, aes(x=`ECa3`, y=`Peak_Resistance`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa3VDepth_to_peak <- ggplot(Lameroo, aes(x=`ECa3`, y=`Depth_to_peak`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa3VDepth_to_2.5MPa <- ggplot(Lameroo, aes(x=`ECa3`, y=`Depth_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa3VArea_under_curve_to_2.5MPa <- ggplot(Lameroo, aes(x=`ECa3`, y=`Area_under_curve_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa3VArea_under_curve_to_50cm <- ggplot(Lameroo, aes(x=`ECa3`, y=`Area_under_curve_to_50cm`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa3_plots_Reg_1
ggexport(ECa3_plots_Reg_1, filename = "X:/Therese_Jackie/smart_farms/sites/Wikarie/Analysis/plots_regression/ECa3_plots_Reg.png")
...
ECa4VPeak <- ggplot(Lameroo, aes(x=`ECa4`, y=`Peak_Resistance`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa4VDepth_to_peak <- ggplot(Lameroo, aes(x=`ECa4`, y=`Depth_to_peak`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa4VDepth_to_2.5MPa <- ggplot(Lameroo, aes(x=`ECa4`, y=`Depth_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa4VArea_under_curve_to_2.5MPa <- ggplot(Lameroo, aes(x=`ECa4`, y=`Area_under_curve_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa4VArea_under_curve_to_50cm <- ggplot(Lameroo, aes(x=`ECa4`, y=`Area_under_curve_to_50cm`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
ECa4_plots_Reg_1
ggexport(ECa4_plots_Reg_1, filename = "X:/Therese_Jackie/smart_farms/sites/Wikarie/Analysis/plots_regression/ECa4_plots_Reg.png")
...
TillageVPeak <- ggplot(Lameroo, aes(x=`Tillage`, y=`Peak_Resistance`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
TillageVDepth_to_peak <- ggplot(Lameroo, aes(x=`Tillage`, y=`Depth_to_peak`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
TillageVDepth_to_2.5MPa <- ggplot(Lameroo, aes(x=`Tillage`, y=`Depth_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
TillageVArea_under_curve_to_2.5MPa <- ggplot(Lameroo, aes(x=`Tillage`, y=`Area_under_curve_to_2.5MPa`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
TillageVArea_under_curve_to_50cm <- ggplot(Lameroo, aes(x=`Tillage`, y=`Area_under_curve_to_50cm`)) + 
  geom_point(alpha =0.5, size=0.3)+
  theme_bw()+
  geom_smooth(method = lm, se = FALSE) +
  stat_regline_equation(
...
Tillage_plots_Reg_1
ggexport(Tillage_plots_Reg_1, filename = "X:/Therese_Jackie/smart_farms/sites/Wikarie/Analysis/plots_regression/Tillage_plots_Reg.png")
